...
public class PostNewVoteTest extends MvcTest {
    ...
    public static Stream<Arguments> getPostNewVoteTestArguments() {
        return Stream.of(
                Arguments.of("Success Vote Test", "1", "5", "open", true),
                Arguments.of("Already Voted Test", "1", "4", "open", false),
                Arguments.of("Vote on Own Poll Test", "1", "2", "own", false)
        );
    }
    ...
    void postNewVoteTest(
            String name, String userId, String pollId, String listing, Boolean success
    ) throws Exception {
